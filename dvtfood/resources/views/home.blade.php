                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    @endphp
                                    @foreach ($categories as $category)
                                        <div class="@php echo $firstActiveTab ? "active" : ""; $firstActiveTab = false; @endphp tab-pane" id="category{{ $category->id }}">
                                            <div class="row g-3">
                                                                ...
                                                                <div class="row text-center">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <button class="btn btn-danger"><i
                                                                                class="fas fa-shopping-cart" data-id="{{ $product->id }} btn-buy"></i> Đặt hàng
                                                                            ngay</button>
                                                                    </div>
                                                                </div>
